...
class SkillVersionCommentControllerTest {
    ...
    void list_returns_page_anonymously() throws Exception {
        ...
        mockMvc.perform(get("/api/web/skill-versions/99/comments"))
    ...
    void list_falls_back_to_author_id_when_lookup_misses() throws Exception {
        SkillVersionComment c = new SkillVersionComment(99L, "ghost", "hi");
    ...
    void create_persists_with_authenticated_principal() throws Exception {
        ...
        mockMvc.perform(post("/api/web/skill-versions/99/comments")
    ...
    void create_with_invalid_body_returns_400() throws Exception {
        ...
        when(service.post(eq(99L), eq("alice"), anyString()))
                .thenThrow(new com.iflytek.skillhub.domain.shared.exception.DomainBadRequestException(
                        "error.comment.body.empty"));
