...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agent-versions/*/comments"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agent-versions/*/comments"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/agents/*/*/archive"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/tags"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/tags"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/v1/agents/*/*/tags/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/web/agents/*/*/tags/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/agents/*/*/tags/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/agents/*/*/tags/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/labels"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/labels"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/v1/agents/*/*/labels/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/web/agents/*/*/labels/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/agents/*/*/labels/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/agents/*/*/labels/*"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/agents/*/*/versions/*/withdraw-review"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/agents/*/*/versions/*/withdraw-review"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/agents/*/*/versions/*/rerelease"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/agents/*/*/versions/*/rerelease"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/agents/*/*/versions/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/agents/*/*/versions/*"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/versions/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/versions/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/agents/*/*/tags/*/download"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/agents/*/*/tags/*/download"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/comments/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/comments/*/pin"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/comments/*/pin"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/agent-versions/*/comments"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/agent-versions/*/comments"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/v1/agent-comments/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PATCH, "/api/web/agent-comments/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/v1/agent-comments/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.DELETE, "/api/web/agent-comments/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/agent-comments/*/pin"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/agent-comments/*/pin"),
