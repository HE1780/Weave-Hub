> **Recovered 2026-05-08** — 本文件曾在 commit `084cd9cc`(2026-04-29 文档精简)中被误删,从 `084cd9cc^:docs/adr/0003-fork-scope-and-upstream-boundary.md` 还原。memo/plan 中所有指向本文件的链接重新生效。
